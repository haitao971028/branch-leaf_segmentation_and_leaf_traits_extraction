...
class get_model(nn.Module):
    def __init__(self, num_classes, normal_channel=False):
        ...
        # self.sa1 = PointNetSetAbstractionMsg(512, [0.05, 0.1, 0.2], [16, 32, 64], 3 + additional_channel,[[32, 32, 64], [64, 64, 128], [64, 96, 128]])
        self.sa2 = PointNetSetAbstractionMsg(128, [0.4,0.8], [64, 128], 128+128+64, [[128, 128, 256], [128, 196, 256]])
        # self.sa2 = PointNetSetAbstractionMsg(128, [0.2, 0.4], [32, 64], 128 + 128 + 64,[[128, 128, 256], [128, 196, 256]])
...
class get_loss(nn.Module):
    ...
    def forward(self, pred, target, trans_feat,weight):
        # weight = np.array(pred.shape[0],2)
